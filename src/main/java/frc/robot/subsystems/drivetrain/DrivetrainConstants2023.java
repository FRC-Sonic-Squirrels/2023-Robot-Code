...
public class DrivetrainConstants2023 extends DrivetrainConstants {
  public DrivetrainConstants2023() {
    ...
    FRONT_LEFT_MODULE_INVERT_DRIVE = false;
    FRONT_LEFT_MODULE_INVERT_STEER = false;
    ...
    FRONT_RIGHT_MODULE_INVERT_DRIVE = false;
    FRONT_RIGHT_MODULE_INVERT_STEER = false;
    ...
    BACK_LEFT_MODULE_INVERT_DRIVE = true; // FIXME: invert back left drive
    BACK_LEFT_MODULE_INVERT_STEER = false;
    ...
    BACK_RIGHT_MODULE_INVERT_DRIVE = false;
    BACK_RIGHT_MODULE_INVERT_STEER = true; // FIXME: invert back right steer

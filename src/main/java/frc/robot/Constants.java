...
public final class Constants {
  ...
  public static class Elevator {
    ...
    // FIXME: old value was 48.85 we adjusted the limit switch
    public static final double MAX_HEIGHT_INCHES = 48.70; // 49.1 max physical
  ...
  public static final class NODE_DISTANCES {
    ...
    public static final double EXTENSION_MID_CONE = 13.0;
    ...
    public static final double HEIGHT_MID_CONE = 35;
